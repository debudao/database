...
INSERT INTO `playwright` VALUES (30, '徐峥');
...
INSERT INTO `playwrightmovie` VALUES (1, 30);
...
CREATE TABLE `tag`  (
  ...
  CONSTRAINT `tag_ibfk_1` FOREIGN KEY (`mid`) REFERENCES `movie` (`mid`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `typemovie` VALUES (1, 3);
...
INSERT INTO `user` VALUES (21, 'yangth@163.com', '123456', '杨嘻嘻', '13098765230');
